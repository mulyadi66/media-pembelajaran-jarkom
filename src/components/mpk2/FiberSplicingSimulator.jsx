...
export default function FiberSplicingSimulator() {
  ...
  const sectionStyle = { background: '#2d2d44', borderRadius: 10, padding: 20, marginBottom: 16 };
  const labelStyle = { fontSize: 13, color: '#94a3b8', marginBottom: 4 };
  const valStyle = { fontSize: 14, fontWeight: 600, color: '#fff' };
    ...
    <div style={{ background: '#1e1e2e', borderRadius: 12, padding: 24, color: '#fff' }}>
      ...
      <div style={{ display: 'flex', gap: 6, marginBottom: 20, flexWrap: 'wrap' }}>
        {STEPS.map((s, i) => (
          <div key={i} style={{
            ...
            background: i === step ? '#6366f1' : i < step ? '#2d5a27' : '#2d2d44',
      ...
      {step === 1 && (
        <div style={sectionStyle}>
          ...
          <div style={{
            ...
            padding: 12, borderRadius: 8, background: '#1e1e2e',
          }}>
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: '#94a3b8', marginBottom: 4 }}>
                <span>Fiber 1</span><span>{fiber1Pos}</span>
              </div>
              <div style={{ background: '#3b3b52', borderRadius: 5, height: 12, position: 'relative' }}>
                <div style={{ ...barStyle, width: `${fiber1Pos}%`, background: '#6366f1' }} />
                <div style={{
            ...
            <div style={{
              ...
              background: isAligned ? '#166534' : '#7f1d1d',
            }}>
      ...
      {step === 2 && (
        <div style={sectionStyle}>
          ...
          <div style={{
            height: 120, background: '#1e1e2e', borderRadius: 8, display: 'flex',
            ...
            <div style={{
              ...
              <div style={{ width: 60, height: 6, background: '#6366f1', borderRadius: 3 }} />
              <div style={{
                width: 40, height: 40, borderRadius: '50%',
                background: arcOn
                  ? 'radial-gradient(circle, #ff6b35, #ff4500, #ff8c00)'
                  : arcDone ? '#6366f1' : '#3b3b52',
          ...
          <div style={{ textAlign: 'center', marginBottom: 16, fontSize: 14, color: '#94a3b8' }}>
      ...
      {step === 3 && (
        <div style={sectionStyle}>
          ...
          <div style={{ background: '#1e1e2e', borderRadius: 8, padding: 4, marginBottom: 16 }}>
            <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, fontSize: 13, color: '#94a3b8', marginBottom: 16 }}>
      ...
      {step === 4 && (
        <div style={sectionStyle}>
          ...
          <div style={{ display: 'grid', gap: 12, fontSize: 14, marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#1e1e2e', borderRadius: 6 }}>
