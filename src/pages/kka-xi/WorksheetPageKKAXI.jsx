...
import { worksheetsKKAXI } from '../../data/kka-xi/worksheetsKKAXI';

export default function WorksheetPageKKAXI() {
  ...
  const modul = worksheetsKKAXI[activeModule];

  return (
    <div className="content-section">
      <div className="materi-card fade-in">
        <h3><FileText size={20} /> Lembar Kerja Praktik KKA XI</h3>
        ...
        <div className="ws-tabs">
          {Object.entries(worksheetsKKAXI).map(([key, val]) => (
