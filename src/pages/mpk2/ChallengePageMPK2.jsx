...
import { challengeMPK2 } from '../../data/mpk2/challengeMPK2';
...
export default function ChallengePageMPK2() {
  ...
  const startGame = () => {
    const qs = shuffle(challengeMPK2).slice(0, selectedCount);
    setQuestions(qs);
    setCurrentIdx(0);
    setUserAnswer('');
    setResults([]);
    ...
    return (
      <div className="content-section">
        <div className="materi-card fade-in" style={{textAlign:'center', maxWidth: 600, margin: '0 auto'}}>
          <h3><Zap size={20} /> Latihan Cepat MPK 2</h3>
          <p style={{marginBottom: 24, color:'var(--text-light)'}}>
            Uji kecepatanmu menjawab pertanyaan seputar Teknologi Jaringan Kabel dan Nirkabel!
          </p>
