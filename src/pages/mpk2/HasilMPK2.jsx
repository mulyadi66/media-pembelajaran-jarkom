...
export default function HasilMPK2() {
  ...
  return (
    <div className="content-section">
      ...
      <div className="result-card fade-in">
        <h2 style={{marginBottom: 20}}><TrendingUp size={20} style={{color: 'var(--primary)', verticalAlign: 'middle'}} /> Ringkasan Perkembangan MPK 2</h2>
      ...
      <div className="result-card fade-in" style={{textAlign: 'left'}}>
        ...
        <ScoreBar label="Pre-Test MPK 2" score={pretestScore} answered={pretestAnswered} />
        <ScoreBar label="Post-Test MPK 2" score={posttestScore} answered={posttestAnswered} />
      ...
      {passed && (
        <div className="result-card fade-in">
          ...
          <Certificate studentName={studentName || 'Siswa'} score={posttestScore} module="MPK 2 JarkomLab" />
        </div>
      )}
