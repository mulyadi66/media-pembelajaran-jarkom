...
import { challengeKKA } from '../../data/kka/challengeKKA';
...
export default function ChallengePageKKA() {
  ...
  const startGame = () => {
    const qs = shuffle(challengeKKA).slice(0, selectedCount);
    setQuestions(qs);
    setCurrentIdx(0);
    setUserAnswer('');
    setResults([]);
    ...
    return (
      <div className="content-section">
        <div className="materi-card fade-in" style={{textAlign:'center', maxWidth: 600, margin: '0 auto'}}>
          <h3><Zap size={20} /> Latihan Cepat KKA</h3>
          <p style={{marginBottom: 24, color:'var(--text-light)'}}>
            Uji kecepatanmu menjawab pertanyaan seputar Koding dan Kecerdasan Artifisial!
          </p>
