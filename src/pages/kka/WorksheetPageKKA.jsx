...
import { worksheetsKKA } from '../../data/kka/worksheetsKKA';

export default function WorksheetPageKKA() {
  ...
  const modul = worksheetsKKA[activeModule];

  return (
    <div className="content-section">
      <div className="materi-card fade-in">
        <h3><FileText size={20} /> Lembar Kerja Praktik KKA</h3>
        ...
        <div className="ws-tabs">
          {Object.entries(worksheetsKKA).map(([key, val]) => (
